...
//舵机类型2引脚value 
Blockly.Blocks.kw_servo2 = {
  init: function () {
    this.setColour(100);
    this.appendValueInput("servopin", Number)
      .setCheck(Number)
      .setAlign(Blockly.ALIGN_RIGHT)
      .appendField(Blockly.KW_SERVOPIN_A)
    this.appendValueInput("servopin2", Number)
      .setCheck(Number)
      .setAlign(Blockly.ALIGN_RIGHT)
      .appendField(Blockly.KW_SERVOPIN_B)
    this.appendValueInput("servopin3", Number)
      .setCheck(Number)
      .setAlign(Blockly.ALIGN_RIGHT)
      .appendField(Blockly.KW_SERVOPIN_D)
    this.setPreviousStatement(true, null);
    this.setInputsInline(true);
    this.setNextStatement(true, null);
