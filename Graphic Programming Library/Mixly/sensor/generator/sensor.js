...
Blockly.Arduino.kw_servo2 = function () {
	var value_servopin = Blockly.Arduino.valueToCode(this, 'servopin', Blockly.Arduino.ORDER_ATOMIC);
	var value_servopin2 = Blockly.Arduino.valueToCode(this, 'servopin2', Blockly.Arduino.ORDER_ATOMIC);
	var value_servopin3 = Blockly.Arduino.valueToCode(this, 'servopin3', Blockly.Arduino.ORDER_ATOMIC);
	Blockly.Arduino.setups_['setup_servo1'] = 'pinMode(' + 'ENCODER_A_PIN' + ', INPUT);';
	Blockly.Arduino.setups_['setup_servo2'] = 'pinMode(' + 'ENCODER_B_PIN' + ', INPUT);';
	Blockly.Arduino.setups_['setup_servo3'] = 'pinMode(' + 'SWITCH_PIN' + ', INPUT);\n';
	Blockly.Arduino.setups_['setup_servo4'] = 'attachInterrupt(1, read_quadrature, CHANGE);';
	Blockly.Arduino.definitions_['define_encoder_pin'] = '#define ENCODER_A_PIN ' + value_servopin + '\n#define ENCODER_B_PIN ' + value_servopin2 + '\n#define SWITCH_PIN ' + value_servopin3;
	// Blockly.Arduino.setups_['setup_input_'+dropdown_pin] = 'pinMode('+dropdown_pin+', INPUT);';
	//PIN = value_servopin3;
	//var code = value_servopin3;
	return "";
};
//��ʼ��7��������
